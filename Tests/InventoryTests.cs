...
public class InventoryTests {
  ...
  [Fact]
  public void Throws_ArgumentException_When_PathToSolution_IsEmpty() {
    Assert.Throws<ArgumentException>((Action)Act);
    return;
    void Act() => _inventory.Start(string.Empty);
  }
  ...
  // This test uses data for the solution and project which are already stored
